...
def init_zone_sizes_generation(first_world_model_zones_total_amount = 100, the_central_zone_range = 100, min_zone_range = 20, max_zone_range = 60):
 first_world_model_zone_sizes = random.randint(min_zone_range,max_zone_range,size=first_world_model_zones_total_amount)
 first_world_model_zone_sizes[0] = the_central_zone_range
